...
public class IntListTest {
    ...
    public void testReverse() {
        ...
        IntList reversed = IntList.of(5, 4, 3, 2, 1);
        IntList originCopy = IntList.of(1, 2, 3, 4, 5);
        assertEquals(IntList.reverse(origin), reversed);
        assertNotEquals(originCopy, origin);
